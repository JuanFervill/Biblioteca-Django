...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('lenguaje', models.CharField(help_text='Idioma del libro', max_length=100)),
            ],
        ),
        migrations.CreateModel(
            name='Book',
            fields=[
                ...
                ('summary', models.TextField(help_text='Breve descripcion del libro', max_length=1000)),
                ...
                ('genre', models.ManyToManyField(help_text='Selecciona genero', to='catalog.genre')),
